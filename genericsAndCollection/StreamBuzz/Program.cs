...
public class CreatorStats
{
    ...
    // Shared list to store all creators
...
public class Program
{
    ...
    /// <summary>
    /// Returns creators and count of weeks
    /// where likes >= given threshold
    /// </summary>
        ...
        double likeThreshold)
    {
        ...
        foreach (CreatorStats creator in records)
        {
            ...
            // Add only if threshold met at least once
            if (count > 0)
            {
    ...
    /// <summary>
    /// Calculates average of all weekly likes
    /// across all creators
    /// </summary>
